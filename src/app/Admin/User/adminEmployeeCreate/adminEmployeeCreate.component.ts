...
@Component({
    selector: 'adminEmployeeCreate',
    templateUrl: './adminEmployeeCreate.component.html',
    styleUrls: ['./adminEmployeeCreate.component.css']
})
export class AdminEmployeeCreateComponent {
    ...
    onCreate() {
        ...
        let user: UserDTO = new UserDTO(null, this.email, this.password1, this.password2, this.lastname, this.firstname, this.birthday, 1, 1);
